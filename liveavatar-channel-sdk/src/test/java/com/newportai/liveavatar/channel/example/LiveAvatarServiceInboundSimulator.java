 ...
 *   Sends control.interrupt                              Sends control.interrupt (echo)
 ...
 *   <li>{@code audio} — sends 20 test PCM audio frames</li>
    ...
    public static void main(String[] args) {
        ...
        AvatarWebSocketClient client = new AvatarWebSocketClient(wsUrl, new AvatarChannelListenerAdapter() {
            ...
            public void onSessionReady(Message message) {
                ...
                System.out.println("   audio     — send 20 test PCM audio frames");
            ...
            public void onControlInterrupt(Message message) {
                System.out.println("⚠️  Received control.interrupt — platform stopped current playback");
            }
